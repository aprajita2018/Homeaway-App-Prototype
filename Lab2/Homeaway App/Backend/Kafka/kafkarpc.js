...
var TIMEOUT     = 32000; //time to wait for response in ms
...
KafkaRPC.prototype.makeRequest = function(topic_name, content, callback){
    ...
    console.log("\n***");
    console.log(" kafkarpc topic :::-> " + topic_name);
    console.log(" kafkarpc correlationId :::-> " + correlationId);
    console.log("***\n");
...
KafkaRPC.prototype.setupResponseQueue = function(producer,topic_name, next){
    ...
    consumer.on('message', function (message) {
        console.log("::: KafkaRPC ::: Data(message) received from backend");
